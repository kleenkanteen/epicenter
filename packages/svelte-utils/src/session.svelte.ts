 ...
 *
 * NEVER the owner of a workspace lifecycle (ADR-0088): a workspace app picks
 * a boot preset regardless of auth. This primitive is for auxiliary
 * signed-in-only resources whose whole existence is tied to an identity, e.g.
 * the vault keyring session.
 *
