...
export const commands = {
	 ...
	 */
	keyringRead: () => typedError<string | null, KeyringError>(__TAURI_INVOKE("keyring_read")),
	/**
	 ...
	 */
	keyringWrite: (value: string | null) => typedError<null, KeyringError>(__TAURI_INVOKE("keyring_write", { value })),
	/**
