...
export const commands = {
	 ...
	 */
	stopRecording: () => typedError<RecordingArtifact, RecorderError>(__TAURI_INVOKE("stop_recording")),
	 ...
	 */
	clearRecordingArtifacts: () => typedError<number, RecorderError>(__TAURI_INVOKE("clear_recording_artifacts")),
	/**
	 ...
	 */
	keyringRead: (account: string) => typedError<string | null, KeyringError>(__TAURI_INVOKE("keyring_read", { account })),
	/**
	 ...
	 */
	keyringWrite: (account: string, value: string | null) => typedError<null, KeyringError>(__TAURI_INVOKE("keyring_write", { account, value })),
	/**
