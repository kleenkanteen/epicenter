...
// The shortcut-binding vocabulary is FE-owned now that Rust no longer sees a
// structured binding (ADR-0117). Native-only consumers may use this barrel;
// shared consumers import `commands.types` so the browser never loads this
// runtime module for a type.
