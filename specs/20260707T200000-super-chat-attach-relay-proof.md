...
- **Nature:** Execution scaffolding for ADR-0115. Proof waves only; no implementation has started. When the waves land, harvest any durable refinement into ADR-0115 and delete this spec (two-state lifecycle).
