...
| [0084](0084-super-chat-tools-load-as-vendored-typescript-the-shell-is-a-bun-hosted-local-server.md) | Super Chat's shell is a Bun-hosted local server; the former vendored-TypeScript loading decision is superseded by 0110 | Proposed (shell packaging still proposed) |
...
| [0097](0097-super-chat-tool-modules-receive-a-host-api.md) | Super Chat tool modules receive a host API | Superseded by 0110 |
...
| [0110](0110-super-chat-v1-exposes-built-in-epicenter-apps-and-defers-extension-surfaces.md) | Super Chat v1 exposes built-in Epicenter apps and defers extension surfaces | Accepted |
